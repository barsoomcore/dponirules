...
if ($querylist{1} != "") { 
	...
	echo "<h4>Fast Task</h4><p>Remember that the <a href=\"Basics.php#Challenges\">Fast Task challenge</a> allows you to make some actions (skill checks and power checks, but not attack rolls or maneuver rolls) in a shorter time than usual.</p>";
