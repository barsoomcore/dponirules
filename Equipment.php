...
<p><a href="EquipmentWeapons.php">Weapons</a>, <a href="EquipmentArmor.php">armor</a>, and some other types of equipment can be constructed as mastercraft objects. The exceptional quality of these objects provides the user a bonus on <a href="Combat.php#AttackBonus">attack rolls</a> and <a href="Combat.php#Parry">Parry</a>, or else they possess some other characteristic.</p>
...
<p>Because the mastercraft property can apply to nearly any quality of an object, some weapons can be made that have special properties for those who know how to make use of them. Any of these properties add +3 to the purchase difficult of the weapon.</p>
<p><b>Hooked:</b> Any <a href="EquipmentWeapons.php?Type=Martial=Melee">martial</a> or <a href="EquipmentWeapons.php?Type=Simple=Melee">simple</a> melee weapon can have a hook added to it. A hooked weapon requires an <a href="Feats.php?Name=Exotic%20Weapon%20Training">Exotic Weapon Training</a> feat to gain any benefit from, but a character who does take <a href="Feats.php?Name=Exotic%20Weapon%20Training">Exotic Weapon Training</a> for the hooked version of their weapon can make <a href="CombatActions.php?Name=Disarm">disarm</a> and <a href="CombatActions.php?Name=Trip">trip</a> attempts with a +2 bonus, just as though they had the <a href="Feats.php?Name=Improved%20Disarm">Improved Disarm</a> and <a href="Feats.php?Name=Improved%20Trip">Improved Trip</a> feats. This weapon bonus stacks with those feats. A weapon that already provides such a bonus cannot have this property.</p>
...
<p><b>Sturdy:</b> Any <a href="EquipmentWeapons.php?Type=Martial=Melee">martial</a> or <a href="EquipmentWeapons.php?Type=Simple=Melee">simple</a> melee weapon can be made extra-sturdy and thus resist breaking more readily. Such a weapon provides a +2 bonus to the user's <a href="Combat.php#Parry">Parry</a>, and its Toughness bonus is increased by +2.</p>
<p><b>Flexible:</b> The following weapons can have the flexible property: <a href="EquipmentWeapons.php?Name=Sword">swords</a>, <a href="EquipmentWeapons.php?Name=Spear">spears</a>, <a href="EquipmentWeapons.php?Name=Staff">staves</a>, <a href="EquipmentWeapons.php?Name=Longspear">longspears</a>, <a href="EquipmentWeapons.php?Name=Polearm">polearms</a> and <a href="EquipmentWeapons.php?Name=Machete">machetes</a>. A weapon with this property is either made of thinner metal (for the bladed weapons) of of a flexible bamboo (for the hafted weapons). Such a weapon cannot be used to <a href="Combat.php#Parry">Parry</a>, but provides a +1 bonus on <a href="Combat.php#AttackBonus">attack rolls</a> and a +2 bonus on <a href="CombatActions.php??Name=Trip">trip</a> or <a href="CombatActions.php?Name=Disarm">disarm</a> attempts.</p>
<p><b>Hold-Out:</b> Any <a href="EquipmentWeapons.php?Type=Martial">martial</a> or <a href="EquipmentWeapons.php?Type=Simple">simple</a> weapon can have this property. Hold-out weapons can more easily be concealed and can be drawn so quickly that a character can surprise their opponents. A hold-out weapon does not suffer the normal -4 penalty on <a href="Skills.php?Name=Sleight%20of%20Hand">Sleight of Hand</a> checks to be concealed as a normal weapon concealed for Quick Draw (see below). In addition, a character with the <a href="Feats.php?Name=Quick%20Draw">Quick Draw</a> feat can draw a hold-out weapon and make a <a href="CombatModifiers.php?Name=Surprise%20Attack">surprise attack</a>, even against an opponent aware of them who has already acted (if that opponent is not aware of the concealed weapon).</p>
