...
<p>The amount by which a missed Toughness save is missed determines how severe the damage is. If the character misses the save by less than 10, they take a <a href="PlayingConditions.php?Name=Hurt">Hurt</a> condition. If they miss by 10 to 14, they take a <a href="PlayingConditions.php?Name=Wounded">Wounded</a> condition, if they miss by 15 to 19 they take a <a href="PlayingConditions.php?Name=Disabled">Disabled</a> condition, and if they miss by 20 or more, they take a <a href="PlayingConditions.php?Name=Dying">Dying</a> condition.</p>

<p>There are 3 <a href="PlayingConditions.php?Name=Hurt">Hurt</a> boxes and one box for each of the other conditions. If a target suffers a result for which all boxes are already checked off, check off the next highest result. Note that boxes may be checked off at a higher level even if lower level boxes are still open due to the severity by which the Toughness save failed: thus if a character has suffered NO damage but misses a Toughness save by 15, they still take the <a href="PlayingConditions.php?Name=Disabled">Disabled</a> condition (and mark an "X" in the Disabled box) even if every other box below that is open.</p>
...
<h3>When You Recover</h3>

<p>Recovery ordinarily takes place at the end of a <a href="BasicsTime.php">scene</a>. <a href="RolesWarrior.php">Warriors</a> can use their role's core ability to spend a <a href="BasicsConviction.php">Conviction point</a> to erase all <a href="PlayingConditions.php?Name=Bruised">Bruised</a> and <a href="PlayingConditions.php?Name=Hurt">Hurt</a> conditions at any time, even during combat.</p>

<p>You can make a single damage recovery check at the end of any <a href="BasicsTime.php">scene</a>. Note that at the end of a scene, if you have no worse condition, you automatically recover any <a href="PlayingConditions.php?Name=Bruised">Bruised</a>, <a href="PlayingConditions.php?Name=Hurt">Hurt</a>, <a href="PlayingConditions.php?Name=Dazed">Dazed</a>, <a href="PlayingConditions.php?Name=Staggered">Staggered</a>, and <a href="PlayingConditions.php?Name=Unconscious">Unconscious</a> conditions. However, if you have a <a href="PlayingConditions.php?Name=Disabled">Disabled</a> or <a href="PlayingConditions.php?Name=Dying">Dying</a> condition, that will prevent you from automatically recovering lesser conditions, since those can only be removed once the more serious conditions are removed. Even if you recover from a Disabled or Dying condition at the end of a scene, you do not get to automatically recover lesser conditions. In addition, you will suffer a carry-over condition as listed in the <a href="BasicsTime.php">scenes rules</a>. Again, the <a href="RolesWarrior.php">Warrior</a> core ability is an exception to this rule.</p>

<p>Anyone can spend <a href="BasicsConviction.php">a Conviction point</a> to get an immediate recovery check DURING a scene from any single damage condition, rather than having to wait. You can also spend <a href="BasicsConviction.php">Conviction</a> on your recovery check (which usually ensures passing it). Note that because you can only spend one <a href="BasicsConviction.php">Conviction</a> point per round unless <a href="PlayingConditions.php?Name=Disabled">disabled</a>, you can't do both (gain a recovery check AND spend <a href="BasicsConviction.php">Conviction</a> on the check).</p>

<h3>Recovering from Ability Damage</h3>
<p><a href="http://localhost/PlayingConditions.php?Name=Ability%20Damaged">Ability damage</a> is recovered just like regular damage, except that a character can choose to recover ability damage before or after any regular damage.</p>
