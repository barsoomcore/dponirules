...
<head>
<title>Adepts</title><?php include ("Scripts/HeaderScript.php"); ?>

<?php include ("Scripts/Menu.php"); ?> 

<img src="/dponiwiki/media/images/KanaAdept.png" style="float:right"><h1>ADEPT</h1>
<p>Intellectual, shaman, mystic, the adept specializes in the sciences and arts of the mind. Adepts are known and respected for their knowledge and insight. They're particularly known for their skill with the supernatural.</p>
<p>Adepts fill many roles in DPoNI. Their arcane <a href="Powers.php">powers</a> range from subtle visions and insight into the psyche to overt manipulations of the physical world.</p>
