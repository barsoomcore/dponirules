...
<p>If you encounter an obstacle, you and the Narrator will have to decide what it is, and in particular how large it is. Note that if you are the quarry of the chase, pursuers who are close to you may have to deal with the obstacle as well. If the obstacle is pretty big (say the size of a market stall), all pursuers at Point-Blank range automatically encounter that obstacle on their turn, and have to decide how to deal with it. If the obstacle is really big (the size of a house), all pursuers at Short or Point-Blank range automatically encounter the obstacle on their turn as well.</p>
...
<h3>Damage</h3>
<p>When you crash into something, its Damage bonus is equal to <a href="CombatDamage.php#Objects">the object's Toughness bonus</a>. So a stone wall deals +8 damage, for example If you are running, this is <a href="CombatDamage.php#NonLethalDamage">non-lethal damage</a>; if you are riding or driving a vehicle, this is lethal damage. For lightweight or otherwise not-too-substantial objects, the Narrator may rule that the damage is reduced or even eliminated (this is known as the Fruit Cart rule).</p>

<h3>Falling Down</h3>
<p>When you collide with an object, you also have to make a Reflex save or <a href="Skills.php?Name=Acrobatics">Acrobatics</a> check (whichever is higher) against a Difficulty of 15. This Difficulty should be increased for larger obstacles. If you fail at this check, you fall prone and automatically lose a range increment against your opponent. If you fail by 20, you fall prone and then a herd of ungulates tramples you.</p>
