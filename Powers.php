...
if ($querylist{1} != "") { 
	...
	echo "<p>Some powers work on the mind of the target and as such, require the wielder to first establish contact with the target's mind. This is done with either the <a href=\"Powers.php?Name=Mind%20Link\">Mind Link</a> power (for sentient creatures) or the <a href=\"Powers.php?Name=Beast%20Link\">Beast Link</a> power (for animals), so all Mental Contact powers require the use of either the <a href=\"Powers.php?Name=Mind%20Link\">Mind Link</a> power or the <a href=\"Powers.php?Name=Beast%20Link\">Beast Link</a> power first.</p>";
	echo "<p>The normal use is to first use <a href=\"Powers.php?Name=Mind%20Link\">Mind Link</a> to contact the target's mind, then, if that attempt is successful, to use the following power to achieve the desired affect. If the <a href=\"Powers.php?Name=Mind%20Link\">Mind Link</a> attempt is unsuccessful, the following power cannot be used.</p>";
