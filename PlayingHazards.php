...
<h2>Heat</h2>
<p>An unprotected character in hot weather must make a Fortitude save (Difficulty 15, + 1 per previous check) or receive a level of <a href="PlayingFatigue.php">fatigue</a>. Additional failed saves cause further levels of <a href="PlayingFatigue.php">fatigue</a>. Once a character is <a href="PlayingConditions.php?Name=Unconscious">unconscious</a>, failed saves cause the character to become <a href="PlayingConditions.php?Name=Disabled">disabled</a>, then <a href="PlayingConditions.php?Name=Dying">dying</a>. Characters may make <a href="Skills.php?Name=Survival">Survival</a> checks to receive a bonus on this saving throw.</p>
...
<p>A Medium character can breathe easily for 6 hours in a sealed chamber measuring 10 feet on a side. After that time, the character suffers a level of <a href="PlayingFatigue.php">fatigue</a> every 15 minutes. Once <a href="PlayingConditions.php?Name=Unconscious">unconscious</a>, the character suffocates and dies. Each additional Medium character or significant fire source (a torch, for example) proportionally reduces the time the air will last. Small characters consume half as much air as Medium characters. A larger volume of air, of course, lasts for a longer time.</p>
