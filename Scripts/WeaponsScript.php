...
function WeaponsList ($field, $term, $range) 
{
    ...
    $evenoddcounter = 1;
	$contentstring = "<table class=\"last-row\" width=\"100%\"><th>Weapon</th><th class=\"center\">Damage</th><th class=\"center\">Critical</th><th class=\"center\">Damage Descriptor</th><th class=\"center\">Range Increment</th><th class=\"center\">Size</th><th class=\"center\">Cost</th>";
    ...
    foreach($dataFromFile as $individualListing) 
    {
        ...
        $contentstring .= "<td class=\"center\">$size</td>";
...
function WeaponDetail ($field, $term)
{
	...
	foreach($dataFromFile as $individualListing)
	{
		...
		$contentstring .= "<h2>$name</h2><table width=\"100%\"><th>Damage</th><th>Critical</th><th>Damage Descriptor</th><th>Range Increment</th><th>Size</th><th>Cost</th><th>Type</th>";
